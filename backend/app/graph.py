...
from app.nodes.intelligence import async_intelligence_node
...
def build_graph():
    ...
    workflow.add_node("intelligence_node", async_intelligence_node)
    ...
    workflow.add_edge("consolidation_node", "intelligence_node")
